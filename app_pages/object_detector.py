...
def page_object_detector_body():
    ...
    st.warning('''
    Click [**here**](https://github.com/EVondrus/SnapSortAI/blob/main/outputs/sample_images.zip),
    to download a set of images from each class for live prediction.''')

    images_buffer = st.file_uploader('Upload images from the different classes here,\
